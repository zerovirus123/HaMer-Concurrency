...
public class MainActivity extends MainActivityBase {
    ...
    protected void startDownloadForResult(ArrayList<Uri> urls) {
        ...
        Log.e(TAG, "Entered MainActivity.startDownloadForResult");
        Intent startIntent = GalleryActivity.makeStartIntent(this, urls);
        startActivityForResult(startIntent, DOWNLOAD_REQUEST_CODE);
    }
    ...
    protected void onActivityResult(
            ...
            int resultCode,
            Intent data) {
        Log.e(TAG, "Entered MainActivity.onActivityResult");
    ...
    private void extractAndUpdateUrls(Intent intent) {
        Log.e(TAG, "Entered MainActivity.extractAndUpdate");
        // Extract the list of downloaded image URLs from the
        // passed intent.
        // TODO - you fill in here.
        ArrayList <Uri> urls = intent.getParcelableArrayListExtra("outputUrls");
